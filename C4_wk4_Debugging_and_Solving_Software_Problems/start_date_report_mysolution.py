...
def get_start_date():
    ...
    year = int(input('Enter a value for the year: '))  # add int convert function
    month = int(input('Enter a value for the month: '))  # add int convert function
    day = int(input('Enter a value for the day: '))  # add int convert function
    print()
...
def list_newer(start_date):
    ...
    # My solution: create a dictionary with key = start_work_date, value = name
    data = get_file_lines(FILE_URL)
    reader = csv.reader(data[1:])
    ldate = {}
    for line in reader:
    ...
    while start_date < datetime.datetime.today():
        ...
        # if start_date in the dictionary, print it
